...
JRS.Controls = function (jQuery, _, Controls) {
  ...
  var ViewModel = Controls.Base.extend({
    constructor: function constructor(args) {
      ...
      _.bindAll(this, "registerEvents", "onControlChange", "_getAllSlaveControlIds", "_getParentControlIds");
    ...
    onControlChange: function onControlChange(event, control) {
  ...
  var Model = {
    ...
    instantiate: function instantiate(jsonStructure) {
      // recreate controls object
      this.controls = {}; // Iterate over each control in passed json
    ...
    createControl: function createControl(jsonControl) {
      ...
      }(jsonControl.type); // Is such control implementation present?
