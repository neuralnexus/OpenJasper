...
UPDATE currency SET date = date_add(date, interval 21 year);
UPDATE promotion SET start_date = date_add(start_date, interval 21 year);
UPDATE expense_fact SET exp_date = date_add(exp_date, interval 21 year);
UPDATE agg_g_ms_pcat_sales_fact_1997 SET the_year = the_year + 21;
UPDATE time_by_day SET the_year = the_year + 21;
UPDATE reserve_employee SET hire_date = date_add(hire_date, interval 21 year);
UPDATE employee SET hire_date = date_add(hire_date, interval 21 year);
UPDATE time_by_day SET the_date = date_add(the_date, interval 21 year);
...
UPDATE store SET first_opened_date = date_add(first_opened_date, interval 15 year);
UPDATE store SET last_remodel_date = date_add(last_remodel_date, interval 15 year);
UPDATE store_ragged SET first_opened_date = date_add(first_opened_date, interval 15 year);
UPDATE store_ragged SET last_remodel_date = date_add(last_remodel_date, interval 15 year);
