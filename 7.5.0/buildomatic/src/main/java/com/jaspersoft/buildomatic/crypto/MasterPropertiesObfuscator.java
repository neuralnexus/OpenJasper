	...
	public void execute() throws BuildException {
		try {
			...
			if (encFlag && !encDoneFlag) {
				String blockSzStr = config.getString(BuildEnc.ENC_BLOCK_SIZE.toString());
				String keySzStr = config.getString(BuildEnc.KEYSIZE.toString());
				EncryptionProperties encProps =
						new EncryptionProperties(
								blockSzStr != null ? Integer.parseInt(blockSzStr) : (Integer) BuildEnc.ENC_BLOCK_SIZE.value(),
								config.getString(BuildEnc.ENC_TRANSFORMATION.toString(), (String) BuildEnc.ENC_TRANSFORMATION.value()),
								keySzStr != null ? Integer.parseInt(keySzStr) : (Integer) BuildEnc.KEYSIZE.value(),
								config.getString(BuildEnc.KEYALG.toString(), (String) BuildEnc.KEYALG.value())
								);
				...
				//obtain key
				Key secret = ksManager.getKey(BuildEnc.ID);
