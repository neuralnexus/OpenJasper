(self["webpackChunkjrs_ui"] = self["webpackChunkjrs_ui"] || []).push([[5076],{
...
(function (GLOBAL) {
  ...
  function _escapeXSS(s) {
    if (typeof $.escapeXSS === 'undefined') throw new Error('$.escapeXSS must be defined in order to use this version of PrototypeJs.');
    return $.escapeXSS(s);
  }
})(this);
...
//# sourceMappingURL=chunk.prototypejs.js.map