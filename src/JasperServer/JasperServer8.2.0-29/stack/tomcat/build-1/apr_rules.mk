...
#
apr_builddir=/opt/bitnami/tomcat/build-1
apr_builders=/opt/bitnami/tomcat/build-1
top_builddir=/opt/bitnami/tomcat/build-1
...
#
CFLAGS=-s
CPPFLAGS=-I/opt/bitnami/tomcat/include -I/opt/bitnami/apache/include
LDFLAGS=-Wl,-rpath=/opt/bitnami/tomcat/lib -L/opt/bitnami/tomcat/lib -Wl,-rpath=/opt/bitnami/apache/lib -L/opt/bitnami/apache/lib
LIBS=
DEFS=-DHAVE_CONFIG_H
