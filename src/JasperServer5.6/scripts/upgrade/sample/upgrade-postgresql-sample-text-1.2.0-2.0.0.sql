...
update JIResourceFolder set uri = '/analysis' || substring( uri from 6 )
where uri like '/olap%';

update JIObjectPermission set uri = '/analysis' || substring ( uri from 6 )
where uri like '/olap%';
update JIObjectPermission set uri = 'repo:/analysis' || substring ( uri from 11 )
