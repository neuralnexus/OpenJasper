...
define(function (require) {
    ...
    var DataProvider = function(options) {
        ...
        this.saveLastCriteria = typeof options.saveLastCriteria !== "undefined" ? options.saveLastCriteria : true;
        //saved criteria;
    ...
    _.extend(DataProvider.prototype, {
        ...
        getData: function(options) {
            options = options || {};
            if (options.criteria) {
                return this._getDataByCriteria(options.criteria)(options);
            } else if (typeof options.criteria === "undefined" && this.saveLastCriteria && this.lastCriteria) {
        ...
        _requestData: function(options, pagesToLoad, deferred) {
            ...
            if (typeof this.dataCacheTotal !== "number") {
        ...
        _putDataToCache: function(options, result) {
            ...
            var cachePageStart = options.offset / this.pageSize,
                cachePageEnd = (Math.min(options.limit, result.data.length) + options.offset - 1) / this.pageSize;
