...
import static com.jaspersoft.jasperserver.dto.adhoc.DefaultISOFormats.TIME_WITHOUT_MILLISECONDS_PATTERN;
import static com.jaspersoft.jasperserver.dto.adhoc.DefaultISOFormats.TIME_WITHOUT_TIMEZONE_PATTERN;
...
public class ELTimeAdapter extends XmlAdapter<String, Time> {
    ...
    public Time unmarshal(String v) throws Exception {
        return new Time(DateUtils.parseDate(v, TIME_WITHOUT_TIMEZONE_PATTERN, TIME_WITHOUT_MILLISECONDS_PATTERN).getTime());
    }
}