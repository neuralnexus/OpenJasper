...
public class JdbcMetadataBuilder implements MetadataBuilder<Connection>,
    ...
    protected CachedRowSetImpl getCachedRowSet() throws SQLException {
        return new CachedRowSetImpl();
    }

    protected ResultSetWrappingSqlRowSet getResultSetWrappingSqlRowSet(CachedRowSetImpl cachedRowSet) {
