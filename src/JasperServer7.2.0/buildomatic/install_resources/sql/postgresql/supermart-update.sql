...
UPDATE currency SET date = date + interval '15 years';
UPDATE promotion SET start_date = start_date + interval '15 years';
UPDATE expense_fact SET exp_date = exp_date + interval '15 years';
UPDATE agg_g_ms_pcat_sales_fact_1997 SET the_year = the_year + 15;
UPDATE time_by_day SET the_year = the_year + 15;
UPDATE reserve_employee SET hire_date = hire_date + interval '15 years';
UPDATE employee SET hire_date = hire_date + interval '15 years';
UPDATE time_by_day SET the_date = the_date + interval '15 years';
