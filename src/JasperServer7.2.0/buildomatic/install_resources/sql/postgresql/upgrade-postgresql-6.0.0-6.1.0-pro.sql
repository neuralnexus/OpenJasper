...
ALTER TABLE JIProfileAttribute ALTER COLUMN attrValue TYPE varchar(2000);
...
ALTER TABLE JICustomDatasourceProperty ALTER COLUMN name TYPE varchar(200);
ALTER TABLE JICustomDatasourceProperty ALTER COLUMN name SET NOT NULL;

ALTER TABLE JICustomDatasourceResource ALTER COLUMN name TYPE varchar(200);
ALTER TABLE JICustomDatasourceResource ALTER COLUMN name SET NOT NULL;

ALTER TABLE JIResource ALTER COLUMN name TYPE varchar(200);
ALTER TABLE JIResource ALTER COLUMN name SET NOT NULL;
ALTER TABLE JIResource ALTER COLUMN label TYPE varchar(200);
ALTER TABLE JIResource ALTER COLUMN label SET NOT NULL;

ALTER TABLE JIResourceFolder ALTER COLUMN name TYPE varchar(200);
ALTER TABLE JIResourceFolder ALTER COLUMN name SET NOT NULL;
ALTER TABLE JIResourceFolder ALTER COLUMN label TYPE varchar(200);
ALTER TABLE JIResourceFolder ALTER COLUMN label SET NOT NULL;

ALTER TABLE JIVirtualDataSourceUriMap ALTER COLUMN data_source_name TYPE varchar(200);
ALTER TABLE JIVirtualDataSourceUriMap ALTER COLUMN data_source_name SET NOT NULL;

ALTER TABLE JIDomainDatasourceDSRef ALTER COLUMN alias TYPE varchar(200);
