...
var Builder = {
  NODEMAP: {
    ...
    // #7 Jasper: escape XSS
    _escapeXSS: function (s) {
        //TODO: pull up xssUtil via require or make it global?
        if (typeof xssUtil === 'undefined')
            throw new Error('xssUtil must be defined in order to use this version of Scriptaculous.Builder.');
        return xssUtil.softHtmlEscape(s);
    },
