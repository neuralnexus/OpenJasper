...
define(function (require, module) {
    ...
    var
        ...
        TooltipModel = require("./model/TooltipModel"),
    ...
    var Tooltip = Backbone.View.extend({
        ...
        initialize: function (options) {
            ...
            if (!_.isEmpty(dataOptions)) {
                if (Tooltip.areSomeKeysEqual(dataOptions, options)) {
                    this.log.warn(
                        "The same options found both in constructor and in 'data-' attrs. Don't use both"
                    );
                }
        ...
        show: function () {
            ...
            // we attach tooltip to body to get its dimensions
            $("body").append(this.tooltipView.$el);
            this.tooltipModel.set({
                visible: true
            });

            // then calculate positions and set it
            this._positionTooltip();

            // then position tooltip as requested
            ...
            // and position again with the same offset
        ...
        readTooltipDataFromDomElement: function (elem) {
            ...
            // remove cached jquery data attributes values, to read up to date values
