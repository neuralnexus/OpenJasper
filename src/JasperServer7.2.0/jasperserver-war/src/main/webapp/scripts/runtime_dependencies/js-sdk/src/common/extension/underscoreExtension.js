...
define(function (require) {
    ...
    var _ = require("underscore"),
        $ = require("jquery"), // Note: jQuery depends on `xssUtil`, be careful of circular deps
        cloneDeep = require("common/util/cloneDeep"),
    ...
    _.mixin({
        ...
        template: function(text, data, options) {
            ...
            // we need dynamic here loading for visualize.js
