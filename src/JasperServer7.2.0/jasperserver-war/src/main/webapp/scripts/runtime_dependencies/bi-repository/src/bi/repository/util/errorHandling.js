...
/**
 * Utility module to handle errors in domain designer application
 *
...
define(function(require) {
    var _ = require("underscore"),
        logger = require("logger").register("ResourceErrors"),
        i18n = require("bundle!RepositoryResourceBundle");
    ...
    return {
        mapXhrErrorToMessage: function(xhr, errorMessages) {
            ...
            logger.warn(xhr.status, errorCodeFromXhr, messageFromXhr);
