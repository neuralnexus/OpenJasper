...
<%-- xssUtil needs to be downloaded before require.js, so that xssUtil consumes global __jrs.configs__ and creates a global xssUtil object for jQuery/prototype/scriptaculous/legacy code --%>
<script type="text/javascript" src="${scriptsUri}/runtime_dependencies/js-sdk/src/common/util/xssUtil.js"></script>
...
<script type="text/javascript" src="${scriptsUri}/runtime_dependencies/jquery/dist/jquery.js"></script>
<%-- Load CSRF protection asap, right after loading jquery. --%>
