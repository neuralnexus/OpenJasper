...
public class RepositoryAclServiceImplTest {
    ...
    //test disabled because it`s require SpringContext
    @Test(enabled = false)
    public void readAclDuringImport() throws Exception {
        // When import is happend we always should get Admin access
