...
UPDATE currency SET date = date + interval '21 years';
UPDATE promotion SET start_date = start_date + interval '21 years';
UPDATE expense_fact SET exp_date = exp_date + interval '21 years';
UPDATE agg_g_ms_pcat_sales_fact_1997 SET the_year = the_year + 21;
UPDATE time_by_day SET the_year = the_year + 21;
UPDATE reserve_employee SET hire_date = hire_date + interval '21 years';
UPDATE employee SET hire_date = hire_date + interval '21 years';
UPDATE time_by_day SET the_date = the_date + interval '21 years';
...
UPDATE store SET first_opened_date = first_opened_date + interval '15 years';
UPDATE store SET last_remodel_date = last_remodel_date + interval '15 years';
UPDATE store_ragged SET first_opened_date = first_opened_date + interval '15 years';
UPDATE store_ragged SET last_remodel_date = last_remodel_date + interval '15 years';
...
-- 
-- change case of a couple columns
-- 
ALTER TABLE product RENAME COLUMN "SKU" TO "sku";
ALTER TABLE product RENAME COLUMN "SRP" TO "srp";
